                ...
                <tr>
                    ...
                    <td>
                     <div class="dropdown show">
                        <a class="lol" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span></span>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                           <a class="dropdown-item lol"  href="detail.peminjaman.php?id=<?=$Bar[0]?>&j=m">
                           Detail</a>
                             <form action="../proses/peminjaman.php?proses=Pengembalian" method="POST">
                                <input type="hidden" name="id" value="<?php echo $Bar[0]; ?>">
                                <input type="submit" class="dropdown-item lol" value="Dikembalikan">
                            </form>
                    </div>
                </div>
            </td>        
